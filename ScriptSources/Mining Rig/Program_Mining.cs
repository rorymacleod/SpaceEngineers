...
namespace IngameScript
{
    partial class Program : MyGridProgram
    {
        ...
        public Program() : base()
        {
            ...
            Commands.Add("swap", SwapConnection);
            Commands.Add("toggle", ToggleDrills);
        }
        ...
        private IEnumerator<UpdateFrequency> Initialize()
        {
            ...
            System = new DrillSystem(Config, Output, this);
        ...
        private IEnumerator<UpdateFrequency> SwapConnection()
        {
            Output.WriteTitle("Mining Rig: Swap Connection");
            foreach (var update in System.SwapConnection())
            {
                yield return update;
            }
        }

        private IEnumerator<UpdateFrequency> ToggleDrills()
        {
            Output.WriteTitle("Mining Rig: Toggle Drills");
            foreach (var update in System.ToggleDrills())
            {
                yield return update;
            }
        }
